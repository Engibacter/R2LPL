...
The released checkpoints have been verified to reproduce similar closed-loop performance trends to those reported in the paper. We are actively improving the documentation and will continue to update the repository with cleaner scripts and additional instructions.
